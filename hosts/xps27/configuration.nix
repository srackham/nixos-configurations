...

{
  ...
  networking.hostName = "xps27"; # Define your hostname.
  ...
  users = {
    ...
    # Guest user created during NixOS install.
    users.guest = {
      isNormalUser = true;
      description = "Guest User";
      extraGroups = [
  ...
  # Don't forget copy copy GMail app password to /secrets/gmail
  programs.msmtp = {
    enable = true;
    defaults = {
      port = 587;
